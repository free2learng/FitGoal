...
export const stubbornBellyFatKillerProgram: WorkoutProgram = {
  ...
  exercises: [
    ...
    {
      name: "Push-ups beginner version",
      sets: 3,
      reps: "6-8 reps",
      restSeconds: 50,
      tutorialUrl: demo("incline push up beginner form"),
      difficulty: "beginner",
      targetMuscles: ["Chest", "Triceps", "Shoulders", "Core"],
      animationUrl: "",
      instructions: ["Use a bench, counter, or wall", "Brace like a plank", "Lower chest toward the surface and push away"],
      commonMistakes: ["Hips sagging", "Elbows flaring straight out", "Dropping the head first"],
      beginnerTips: ["Use a higher surface to make it easier", "Keep every rep clean before lowering the incline"],
      metValue: 3.8,
      durationMinutesPerSet: 0.75
    },
    {
      ...
      reps: "8 each side",
      restSeconds: 45,
      tutorialUrl: demo("reverse lunge beginner form"),
      difficulty: "moderate",
      targetMuscles: ["Quads", "Glutes", "Hamstrings"],
      animationUrl: "",
      instructions: ["Stand tall", "Step one foot back into a long stance", "Drive through the front heel to stand"],
      commonMistakes: ["Short step", "Front knee caving inward", "Pushing mostly from the back foot"],
      beginnerTips: ["Hold a wall for balance", "Use a smaller range if knees feel sensitive"],
      metValue: 4.5,
      durationMinutesPerSet: 0.8
    },
    {
      ...
      reps: "8 each side",
      restSeconds: 35,
      tutorialUrl: demo("dead bug exercise beginner form"),
      difficulty: "beginner",
      targetMuscles: ["Core", "Deep abs"],
      animationUrl: "",
      instructions: ["Lie on your back with knees up", "Press lower back gently down", "Extend opposite arm and leg slowly"],
      commonMistakes: ["Back arching", "Moving too quickly", "Reaching too far before control is ready"],
      beginnerTips: ["Start with heel taps", "Exhale as the arm and leg move away"],
      metValue: 2.8,
      durationMinutesPerSet: 0.75
    },
    {
      ...
      reps: "8 each side",
      restSeconds: 35,
      tutorialUrl: demo("bird dog beginner form"),
      difficulty: "beginner",
      targetMuscles: ["Core", "Back", "Glutes"],
      animationUrl: "",
      instructions: ["Start on hands and knees", "Reach opposite arm and leg long", "Pause without twisting your hips"],
      commonMistakes: ["Rotating the torso", "Arching the lower back", "Rushing reps"],
      beginnerTips: ["Start with legs only", "Use a short reach until stable"],
      metValue: 2.8,
      durationMinutesPerSet: 0.75
    },
    {
      ...
      reps: "25 seconds",
      restSeconds: 45,
      tutorialUrl: demo("wall sit beginner form"),
      difficulty: "moderate",
      targetMuscles: ["Quads", "Glutes", "Core"],
      animationUrl: "",
      instructions: ["Place back against wall", "Slide into a comfortable squat", "Keep knees tracking over toes and breathe"],
      commonMistakes: ["Sitting too low too soon", "Holding breath", "Letting knees cave inward"],
      beginnerTips: ["Start higher than parallel", "Stand up before knee discomfort"],
      metValue: 3.5,
